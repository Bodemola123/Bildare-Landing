...
<button
  ...
  disabled={loading}
  className="absolute right-2 top-1/2 -translate-y-1/2 md:px-5 md:py-2.5 px-3 py-2 rounded-2xl bg-[#B9F500] text-black text-xs md:text-base font-semibold whitespace-nowrap cursor-pointer disabled:opacity-70"
>
  {loading ? (
