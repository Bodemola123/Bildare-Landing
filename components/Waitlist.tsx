...
const Waitlist = () => {
  return (
    <div className="flex flex-col items-center justify-center px-4 md:px-8 lg:px-16 py-16 min-h-screen">
      <div className='flex flex-col lg:flex-row items-center justify-center gap-10 md:gap-16 lg:gap-23 border border-[#2E2E2E] rounded-3xl p-6 md:p-10 w-full'>
        ...
        <div className='flex flex-col justify-center gap-4 md:gap-6 items-center md:items-start text-center md:text-left w-full md:w-auto lg:w-159.25'>
          ...
          <h2 className='text-2xl md:text-4xl lg:text-5xl font-semibold text-[#ffffff] w-full md:w-159.25'>
